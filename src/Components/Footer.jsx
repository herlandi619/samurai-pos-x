...
<div className='bg-slate-900'>
    ...
    <div>
        <h1 className="w-full text-3xl font-bold text-[#8FE4FF]">X-SM</h1>
...
<div className=''>
        <p className='font-[Golos Text] text-xs py-7 text-center text-gray-400'>Copyright Herlandi || Tailwindcss / RectJs / Figma 2023</p>
    </div>
</div>
